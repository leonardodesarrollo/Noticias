                        ...
                        <asp:GridView ID="grvAlertas" runat="server" ClientIDMode="Static" CssClass="table table-responsive table-condensed table-bordered table-striped small"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Q Noticias No Relevantes">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnIrFeed" OnClick="btnIrFeed_Click" Width="100%" runat="server" CssClass="btn btn-xs btn-warning">
                                            <asp:Label ID="lblCantidadNoticias" runat="server" Text='<%# Bind("CantidadNoticias") %>'></asp:Label>
                                            <span class="glyphicon glyphicon-link"></span></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Q Noticias Relevantes">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnIrFeedRelevantes" OnClick="btnIrFeedRelevantes_Click" Width="100%" runat="server" CssClass="btn btn-xs btn-success">
                                            <asp:Label ID="lblCantidadNoticiasRelevantes" runat="server" Text='<%# Bind("CantidadNoticiasRelevantes") %>'></asp:Label>
                                            <span class="glyphicon glyphicon-link"></span></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
