<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="Mandantes.aspx.cs" Inherits="NoticiasMaster.Mandantes" %>
             ...
             <div class="panel-body">
                 <asp:GridView ID="grvMandantes" runat="server" ClientIDMode="Static" CssClass="table table-responsive table-condensed table-bordered table-striped small"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nom Empresa">
                            <ItemTemplate>
