<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="NoticiasMaster.Login" %>
...
<%--             <img src="assets/img/logo_mini_interweb.png" class="img-rounded" />--%>
        <%--  <img src="assets/img/logo_PNG_Small.png" class="img-rounded" width="50%" />--%>
            <h2>By GetSoft</h2>
        </div>
